"""Regression checks for the amber-tool-trace-stack casebook."""
...
from casebook.harness import assert_expected, amber_tool_trace_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_tool_trace_stack_summary(), assert_expected())
